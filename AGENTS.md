...
- **No Bangla Input Fields**: Never add Bangla translation input fields (e.g., Bangla title, Bangla subtitle, Bangla description) in the Admin panel. Admin input forms should only use standard single English input fields.
