        ...
        <div className="relative">
          ...
          {isAvatarOpen && (
            <>
              ...
              {/* Edit Profile panel - rendered on the left side of the main menu dropdown */}
              {avatarView === "edit" && (
                <div className="absolute right-[232px] top-9 mt-1.5 w-56 bg-white border border-slate-200/90 rounded-2xl shadow-xl z-50 p-3 text-[13px] text-slate-700">
