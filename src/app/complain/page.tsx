...
export default function Complain() {
  ...
  const translateCategory = (cat: string) => {
    if (cat === "Support Response Delay") return t(pageContent.str1En, pageContent.str1En);
    if (cat === "Frequent Disconnections") return t(pageContent.str2En, pageContent.str2En);
    if (cat === "Billing Discrepancy") return t(pageContent.str3En, pageContent.str3En);
    if (cat === "Staff Misbehavior") return t(pageContent.str4En, pageContent.str4En);
    if (cat === "Speed Not Matching Pack") return t(pageContent.str5En, pageContent.str5En);
    return cat;
  };
  ...
  const categoryOptions = [
    { value: "Support Response Delay", label: t(pageContent.str17En, pageContent.str17En) },
    { value: "Frequent Disconnections", label: t(pageContent.str18En, pageContent.str18En) },
    { value: "Billing Discrepancy", label: t(pageContent.str19En, pageContent.str19En) },
    { value: "Staff Misbehavior", label: t(pageContent.str20En, pageContent.str20En) },
    { value: "Speed Not Matching Pack", label: t(pageContent.str21En, pageContent.str21En) },
  ];
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm text-left space-y-6">
            {!success ? (
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <h3 className="text-slate-900 font-extrabold text-lg mt-3">{t(pageContent.str11En, pageContent.str11En)}</h3>
                  <p className="text-xs text-slate-500 mt-1">
                    {t(pageContent.str12En, pageContent.str12En)}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs text-slate-600 font-bold uppercase tracking-wider">{t(pageContent.str13En, pageContent.str13En)}</label>
                      <input
                        type="text"
                        required
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs text-slate-600 font-bold uppercase tracking-wider">{t(pageContent.str14En, pageContent.str14En)}</label>
                      <input
                        type="text"
                        required
                        value={form.name}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs text-slate-600 font-bold uppercase tracking-wider">{t(pageContent.str15En, pageContent.str15En)}</label>
                      <input
                        type="tel"
                        required
                        value={form.phone}
                    ...
                    <div className="flex flex-col gap-1.5 relative">
                      <label className="text-xs text-slate-600 font-bold uppercase tracking-wider">{t(pageContent.str16En, pageContent.str16En)}</label>
                      <button
                        type="button"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs text-slate-600 font-bold uppercase tracking-wider">{t(pageContent.str22En, pageContent.str22En)}</label>
                    <textarea
                      required
                      rows={4}
                      value={form.desc}
                ...
                >
                  {submitting ? (
                    <>
                      ...
                      {t(pageContent.str25En, pageContent.str25En)}
                    </>
                  ) : (
              ...
              <div className="text-center py-6 space-y-6">
                ...
                <div className="space-y-2">
                  <h3 className="text-slate-900 font-bold text-xl">{t(pageContent.str27En, pageContent.str27En)}</h3>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 max-w-sm mx-auto font-mono text-left text-slate-700">
                  <div className="flex justify-between border-b border-slate-200 pb-2 mb-2 text-xs text-slate-500">
                    <span>{t(pageContent.str29En, pageContent.str29En)}</span>
                    <span className="text-brand-blue font-bold">{complaintRef}</span>
                  </div>
                  <div className="flex justify-between border-b border-slate-200 pb-2 mb-2 text-xs text-slate-500">
                    <span>{t(pageContent.str30En, pageContent.str30En)}</span>
                    <span className="text-slate-800 font-bold">{form.clientId.toUpperCase()}</span>
                  </div>
                  <div className="flex justify-between border-b border-slate-200 pb-2 mb-2 text-xs text-slate-500">
                    <span>{t(pageContent.str31En, pageContent.str31En)}</span>
                    <span className="text-slate-800 font-semibold">{translateCategory(form.category)}</span>
                  </div>
                  <div className="flex justify-between text-xs text-slate-500">
                    <span>{t(pageContent.str32En, pageContent.str32En)}</span>
                    <span className="text-emerald-600 font-bold">&lt; {t(pageContent.str33En, pageContent.str33En)}</span>
                  </div>
                </div>
                ...
                >
                  {t(pageContent.str36En, pageContent.str36En)}
                </button>
              </div>
            )}
          </div>
