...
export default function Multimedia() {
  ...
  return (
    <div className="w-full bg-white text-slate-900 py-12 relative overflow-hidden flex-grow border-y border-slate-100 min-h-[80vh]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight mt-3">
            Multimedia{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-cyan text-glow">
              &amp; BDIX Portal
            </span>
          </h1>
