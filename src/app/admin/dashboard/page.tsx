        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-6 bg-[#f8fafc]">
          ...
          {activeTab === "Overview" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* SVG Revenue Graph */}
                <div className="bg-white border border-slate-200/90 rounded-[20px] p-6 shadow-sm space-y-4">
                  <div>
                  ...
                  <div className="w-full h-48 bg-slate-50 rounded-2xl flex items-end justify-center p-3 relative border border-slate-100 overflow-hidden">
                    <svg className="w-full h-full" viewBox="0 0 300 100" preserveAspectRatio="none">
                      ...
                      <line x1="0" y1="20" x2="300" y2="20" stroke="#e2e8f0" strokeWidth="0.5" strokeDasharray="4" />
                      <line x1="0" y1="50" x2="300" y2="50" stroke="#e2e8f0" strokeWidth="0.5" strokeDasharray="4" />
                      <line x1="0" y1="80" x2="300" y2="80" stroke="#e2e8f0" strokeWidth="0.5" strokeDasharray="4" />

                      <path d="M0,90 Q50,75 100,80 T200,45 T300,25 L300,100 L0,100 Z" fill="url(#gradient-chart)" />
                      <path d="M0,90 Q50,75 100,80 T200,45 T300,25" fill="none" stroke="#3b82f6" strokeWidth="2.5" />
                      <circle cx="100" cy="80" r="3" fill="#3b82f6" />
                      <circle cx="200" cy="45" r="3" fill="#1d4ed8" />
                      <circle cx="300" cy="25" r="3" fill="#0f172a" />
                    </svg>
                    <div className="absolute bottom-1.5 inset-x-4 flex justify-between text-[8px] text-slate-400 font-mono uppercase">
                      <span>Jan</span>
                      <span>Feb</span>
                      <span>Mar</span>
                      <span>Apr</span>
                ...
                <div className="bg-white border border-slate-200/90 rounded-[20px] p-6 shadow-sm space-y-4">
                  <div>
                    <h3 className="text-slate-900 font-extrabold text-sm tracking-wide">GPON Signal Health (SFP Metrics)</h3>
                    <p className="text-[11px] text-slate-500 mt-0.5">Distribution of subscriber ONT receiving power</p>
                  </div>
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-xs">
                        <span className="text-slate-500 font-medium">Optimal (-16 to -22 dBm)</span>
                        <span className="text-emerald-600 font-bold">94.8%</span>
                      </div>
                      <div className="w-full h-2.5 bg-slate-100 border border-slate-200/70 rounded-full overflow-hidden">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-xs">
                        <span className="text-slate-500 font-medium">Acceptable (-23 to -26 dBm)</span>
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-xs">
                        <span className="text-slate-500 font-medium">Critical Signal drop (&gt; -27 dBm)</span>
          ...
          {activeTab === "Packages" && (
            <div className="bg-white border border-slate-200 shadow-sm rounded-[24px] p-6 space-y-6">
              <div>
                <h2 className="text-lg font-extrabold text-slate-900">Active Broadband Package Catalog</h2>
                <p className="text-xs text-slate-500 mt-1">Simulated consumer and business plans rendered across Southern Keraniganj.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={p.name} className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4 shadow-sm">
                    <span className="text-[10px] text-brand-blue font-bold uppercase tracking-widest">{p.type}</span>
                    <div>
                      <h3 className="text-base font-extrabold text-slate-800">{p.name}</h3>
                      <p className="text-2xl font-black text-emerald-600 mt-1">{p.price}</p>
                    </div>
                    <div className="text-xs text-slate-500">
                      Capped Speed: <strong className="text-slate-800">{p.speed}</strong>
                    </div>
                  </div>
                ))}
              </div>
                              ...
                              {c.status === "Pending" && (
                                <>
                                  ...
                                  <button
                                    ...
                                    className="px-2.5 py-1 bg-slate-500/15 hover:bg-slate-500/25 border border-slate-500/30 text-slate-500 rounded-lg font-bold text-[10px] cursor-pointer"
                                  >
                                    Cancel
                                  </button>
                                </>
