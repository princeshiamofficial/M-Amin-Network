            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  {/* Hero overlay */}
                  <div className="bg-white border border-slate-100/90 rounded-2xl p-5 shadow-sm flex flex-col gap-1">
                    <span className="text-[11px] text-slate-400 font-semibold uppercase tracking-wider">Hero overlay</span>
                    <span className="text-3xl font-extrabold text-slate-900 mt-1">
                      {homeSections.hero ? "ON" : "OFF"}
                    </span>
                    <span className={`text-xs font-semibold mt-0.5 ${homeSections.hero ? "text-emerald-500" : "text-slate-400"}`}>
                  ...
                  {/* Active packages */}
                  <div className="bg-white border border-slate-100/90 rounded-2xl p-5 shadow-sm flex flex-col gap-1">
                    <span className="text-[11px] text-slate-400 font-semibold uppercase tracking-wider">Active packages</span>
                    <span className="text-3xl font-extrabold text-slate-900 mt-1">{countPackages}</span>
                    <span className="text-xs text-slate-400 font-medium mt-0.5">Published plans</span>
                  </div>

                  {/* Active FAQs */}
                  <div className="bg-white border border-slate-100/90 rounded-2xl p-5 shadow-sm flex flex-col gap-1">
                    <span className="text-[11px] text-slate-400 font-semibold uppercase tracking-wider">Active FAQs</span>
                    <span className="text-3xl font-extrabold text-slate-900 mt-1">{faqs.filter((f) => f.isPublished).length || 0}</span>
                    <span className="text-xs text-slate-400 font-medium mt-0.5">Visible on site</span>
                  </div>

                  {/* Total admins */}
                  <div className="bg-white border border-slate-100/90 rounded-2xl p-5 shadow-sm flex flex-col gap-1">
                    <span className="text-[11px] text-slate-400 font-semibold uppercase tracking-wider">Total admins</span>
                    <span className="text-3xl font-extrabold text-slate-900 mt-1">{adminUsers.length || 1}</span>
                    <span className="text-xs text-slate-400 font-medium mt-0.5">Active accounts</span>
                  </div>
