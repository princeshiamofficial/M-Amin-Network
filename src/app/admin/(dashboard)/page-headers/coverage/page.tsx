...
export default function CoverageHeaderPage() {
  ...
  useEffect(() => {
    ...
    getSetting("page_headers").then((s) => {
      ...
      if (data) {
        setTitleEn(data.coverage_title_en || "");
        setHighlightEn(data.coverage_title_highlight_en || "");
        setSubtitleEn(data.coverage_subtitle_en || "");
      }
    });
  }, [router]);
  ...
  const save = async () => {
    ...
    const updated = {
      ...
      coverage_title_bn: titleEn,
      coverage_title_highlight_en: highlightEn,
      coverage_title_highlight_bn: highlightEn,
      coverage_subtitle_en: subtitleEn,
      coverage_subtitle_bn: subtitleEn,
    };
