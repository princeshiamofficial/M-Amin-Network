...
export default function MultimediaHeaderPage() {
  ...
  useEffect(() => {
    ...
    getSetting("page_headers").then((s: any) => {
      if (s) {
        setBg(s.multimedia_bg || "");
        setTitleEn(s.multimedia_title_en || "");
        setTitleBn(s.multimedia_title_bn || "");
        setHighlightEn(s.multimedia_title_highlight_en || "");
        setHighlightBn(s.multimedia_title_highlight_bn || "");
        setSubtitleEn(s.multimedia_subtitle_en || "");
        setSubtitleBn(s.multimedia_subtitle_bn || "");
      }
    });
  }, [router]);
  ...
  const save = async () => {
    ...
    const updated = {
      ...s,
      multimedia_bg: bg,
      multimedia_title_en: titleEn,
      multimedia_title_bn: titleBn,
      multimedia_title_highlight_en: highlightEn,
      multimedia_title_highlight_bn: highlightBn,
      multimedia_subtitle_en: subtitleEn,
      multimedia_subtitle_bn: subtitleBn,
    };
    await setSetting("page_headers", updated);
    setSaved(true);
    toast.success("Multimedia Page Header updated successfully!");
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-start justify-between bg-white border border-slate-200 shadow-sm rounded-xl p-5">
        <div>
          <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">Multimedia Header settings</h1>
          <p className="text-xs text-slate-500 mt-0.5">
            Modify the background image/video and title/subtitle for the public BDIX FTP portals streaming page.
          </p>
        </div>
      ...
      <div className="bg-white border border-slate-200/80 shadow-sm rounded-2xl p-6 space-y-6">
        <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
          ...
          <h2 className="text-base font-bold text-slate-800">Multimedia Page Header config</h2>
        </div>
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <input
                    ...
                    placeholder="e.g. /Multimedia.jpg"
