...
export default function MultimediaHeaderPage() {
  ...
  useEffect(() => {
    ...
    getSetting("page_headers").then((s) => {
      ...
      if (data) {
        setTitleEn(data.multimedia_title_en || "");
        setHighlightEn(data.multimedia_title_highlight_en || "");
        setSubtitleEn(data.multimedia_subtitle_en || "");
      }
    });
  }, [router]);
  ...
  const save = async () => {
    ...
    const updated = {
      ...
      multimedia_title_bn: titleEn,
      multimedia_title_highlight_en: highlightEn,
      multimedia_title_highlight_bn: highlightEn,
      multimedia_subtitle_en: subtitleEn,
      multimedia_subtitle_bn: subtitleEn,
    };
