...
export default function PackagesHeaderPage() {
  ...
  useEffect(() => {
    ...
    getSetting("page_headers").then((s: any) => {
      if (s) {
        setBg(s.packages_bg || "");
        setTitleEn(s.packages_title_en || "");
        setTitleBn(s.packages_title_bn || "");
        setHighlightEn(s.packages_title_highlight_en || "");
        setHighlightBn(s.packages_title_highlight_bn || "");
        setSubtitleEn(s.packages_subtitle_en || "");
        setSubtitleBn(s.packages_subtitle_bn || "");
      }
    });
  }, [router]);
  ...
  const save = async () => {
    ...
    const updated = {
      ...
      packages_title_bn: titleBn,
      packages_title_highlight_en: highlightEn,
      packages_title_highlight_bn: highlightBn,
      packages_subtitle_en: subtitleEn,
      packages_subtitle_bn: subtitleBn,
    };
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-start justify-between bg-white border border-slate-200 shadow-sm rounded-xl p-5">
        <div>
          <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">Packages Header settings</h1>
          <p className="text-xs text-slate-500 mt-0.5">
            Modify the background image/video and title/subtitle for the public packages plans page.
          </p>
        </div>
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <input
                    ...
                    placeholder="e.g. /video/package-header.mp4"
