...
export default function CareersHeaderPage() {
  ...
  useEffect(() => {
    ...
    getSetting("page_headers").then((s) => {
      ...
      if (data) {
        setTitleEn(data.careers_title_en || "");
        setHighlightEn(data.careers_title_highlight_en || "");
        setSubtitleEn(data.careers_subtitle_en || "");
      }
    });
  }, [router]);
  ...
  const save = async () => {
    ...
    const updated = {
      ...
      careers_title_bn: titleEn,
      careers_title_highlight_en: highlightEn,
      careers_title_highlight_bn: highlightEn,
      careers_subtitle_en: subtitleEn,
      careers_subtitle_bn: subtitleEn,
    };
