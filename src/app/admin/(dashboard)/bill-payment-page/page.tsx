...
export default function BillPaymentPageAdmin() {
  ...
  useEffect(() => {
    ...
    if (s) {
      ...
      localStorage.setItem("m_amin_bill_payment_page_content", JSON.stringify(defaultBillPaymentPageContent));
    }
  }, [router]);

  const save = () => {
    localStorage.setItem("m_amin_bill_payment_page_content", JSON.stringify(content));
    setSaved(true);
