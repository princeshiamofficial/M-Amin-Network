...
export default function PortalPageAdmin() {
  ...
  useEffect(() => {
    ...
    if (s) {
      ...
      localStorage.setItem("m_amin_portal_page_content", JSON.stringify(defaultPortalPageContent));
    }
  }, [router]);

  const save = () => {
    localStorage.setItem("m_amin_portal_page_content", JSON.stringify(content));
    setSaved(true);
