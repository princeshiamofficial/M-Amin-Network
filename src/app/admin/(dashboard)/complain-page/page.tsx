...
export const defaultComplainPageContent: ComplainPageContent = {
  str1En: "Support Response Delay",
  str2En: "Frequent Disconnections",
  str3En: "Billing Discrepancy",
  str4En: "Staff Misbehavior",
  str5En: "Speed Not Matching Pack",
  str6En: "Grievance Redressal",
  str7En: "Complain Box & ",
  str8En: "Grievances",
  str9En: "Are you experiencing recurring speed drops, long support delays, or billing discrepancies? Submit a formal complaint directly to our senior administration queue.",
  str10En: "Formal Complaint",
  str11En: "File a Complaint Ticket",
  str12En: "Complaints filed here bypass standard queues and are reviewed directly by the M Amin Network operations manager within 12 hours.",
  str13En: "Client ID (Required)",
  str14En: "Your Full Name",
  str15En: "Phone Number",
  str16En: "Complaint Category",
  str17En: "Support Response Delay (> 4 hours)",
  str18En: "Frequent Disconnections (Physical Signal drop)",
  str19En: "Billing / Payment Update failure",
  str20En: "Staff / Field Technician Misconduct",
  str21En: "Speed not matching package configuration",
  str22En: "Describe the Incident",
  str23En: "Provide details about previous support ticket numbers, dates, times, or field technician names related to your complaint...",
  str24En: "According to BTRC regulatory standards, M Amin Network logs all grievances. We aim to redress complaints within 24 hours. Formal complain tracking references are shared with telecom audit queues.",
  str25En: "Registering Complaint...",
  str26En: "File Formal Complaint",
  str27En: "Complaint Logged!",
  str28En: "Your formal complaint has been registered under BTRC audit standards.",
  str29En: "Complaint ID",
  str30En: "Client Account",
  str31En: "Grievance Category",
  str32En: "Resolution SLA",
  str33En: "24 Hours",
  str34En: "An operations administrator will contact you at",
  str35En: "to investigate this ticket details and discuss resolution steps.",
  str36En: "Close Window",
};
