...
export default function SupportPageAdmin() {
  ...
  useEffect(() => {
    ...
    if (s) {
      ...
      localStorage.setItem("m_amin_support_page_content", JSON.stringify(defaultSupportPageContent));
    }
  }, [router]);

  const save = () => {
    localStorage.setItem("m_amin_support_page_content", JSON.stringify(content));
    setSaved(true);
