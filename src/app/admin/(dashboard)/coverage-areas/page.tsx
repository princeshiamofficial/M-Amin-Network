        ...
        <div className="flex flex-row justify-between items-center gap-2 sm:gap-3">
          ...
          {allowAdd && (
            <button
              ...
              className="px-2.5 sm:px-4 py-2.5 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl text-xs font-extrabold transition-all cursor-pointer shadow-md shadow-indigo-500/10 inline-flex items-center justify-center gap-1.5 active:scale-95 shrink-0"
              title="Add Coverage Zone"
            >
              <Plus className="w-3.5 h-3.5" />
              <span className="hidden sm:inline">Add Coverage Zone</span>
              <span className="inline sm:hidden font-bold">Add</span>
            </button>
          )}
        </div>
              ...
              {filteredZones.map((zone) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      backgroundImage: "linear-gradient(rgba(255, 255, 255, 0.55), rgba(255, 255, 255, 0.55)), url('/mapImg.webp')",
